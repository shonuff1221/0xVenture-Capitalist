...
const commonButtonClass =
  "bg-neutral-100 border text-neutral-800 hover:bg-white hover:border-gray-400 hover:shadow-lg inline-flex h-[35px] items-center justify-center rounded-[4px] px-[15px] font-medium leading-none w-full text-sm focus:bg-neutral-200 focus:shadow-xl";
